...
### Install Jenkins from Jenkins official Image
```
...
```
### Create Custome Jenkins Docker Image 
...
```
Here we need to chage the PATH "JENKINS_HOME="/var/lib/jenkins" to our custome Path
